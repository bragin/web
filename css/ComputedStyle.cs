...
namespace SkiaSharpOpenGLBenchmark
{
    ...
    public class ComputedStyle
    {
        ...
        public CssBorderColorEnum GetBorderBottomColor(ref Color color)
        {
        ...
        public CssBorderColorEnum GetBorderLeftColor(ref Color color)
        {
        ...
        public CssBorderColorEnum GetBorderRightColor(ref Color color)
        {
        ...
        public CssBorderColorEnum GetBorderTopColor(ref Color color)
        {
        ...
        public CssBorderColorEnum ComputedBorderTopColor(ref Color color)
        {
            return GetBorderTopColor(ref color);
        }

        public CssBorderColorEnum ComputedBorderRightColor(ref Color color)
        {
            return GetBorderRightColor(ref color);
        }

        public CssBorderColorEnum ComputedBorderBottomColor(ref Color color)
        {
            return GetBorderBottomColor(ref color);
        }

        public CssBorderColorEnum ComputedBorderLeftColor(ref Color color)
        {
