...
public class CssProps
    {
        ...
        void SetFontSize(ComputedStyle style, CssFontSizeEnum type, Fixed length, CssUnit unit)
        {
        ...
        {
            SetFontSize(state.Computed,
                        CssFontSizeEnum.CSS_FONT_SIZE_MEDIUM,
                        new Fixed(0),
                        CssUnit.CSS_UNIT_PX);
            return CssStatus.CSS_OK;
        }
