...
namespace SkiaSharpOpenGLBenchmark.css
{
    ...
    public delegate CssStatus PropDispCascade(OpCode op, CssStyle style, ref int bi, CssSelectState state);
    ...
    public class CssProps
    {
        ...
        CssStatus PropDispCascade_background_attachment(OpCode op, CssStyle style, ref int bi, CssSelectState state)
        {
            Log.Unimplemented();
        ...
        #region color
        CssStatus PropDispCascade_color(OpCode op, CssStyle style, ref int bi, CssSelectState state)
        {
            ...
            if (inherit == false)
            {
                switch (op.GetValue())
                {
                    ...
                    case (ushort)OpColor.COLOR_SET:
                        ...
                        bi++; //advance_bytecode(style, sizeof(color));
                        break;
                }
            }
        ...
        CssStatus PropDispCascade_fontsize(OpCode op, CssStyle style, ref int bi, CssSelectState state)
        {
            Log.Unimplemented();
            return CssStatus.CSS_OK;
        }
        ...
        CssStatus PropDispCascade_Default(OpCode op, CssStyle style, ref int bi, CssSelectState state)
        {
            Log.Unimplemented();
            return CssStatus.CSS_OK;
        }
